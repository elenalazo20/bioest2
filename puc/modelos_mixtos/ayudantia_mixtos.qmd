---
title: "Ayudantia de Modelos Mixtos en Bioestadística II"
author: "Elena Lazo"
date: "Noviembre 2025"
format:
  html: default
...
# Convertir las variables a factor si aún no lo están
...
📈 Tip profesional
**Usar emmeans o modelbased::estimate_means() para obtener las medias ajustadas por grupo es la forma más clara y recomendada de comunicar resultados cuando hay interacción.**
...
El modelo con interacción (Treatment * sex) no mejora significativamente el ajuste:

- p = 0.615 → muy lejos del umbral de significancia (0.05).
- El AIC incluso aumenta con el modelo más complejo, lo cual indica peor ajuste relativo.
- Por lo tanto, el modelo más simple (modelo_mixto) es preferible.
